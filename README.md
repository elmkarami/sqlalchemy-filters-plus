[![Build Status](https://travis-ci.com/elmkarami/sqlalchemy-filters-plus.svg?token=vFpfbSDup5LPtixMeFAs&branch=main)](https://travis-ci.com/elmkarami/sqlalchemy-filters-plus)
